...
from src import tz
from src.parser import isoparse, isoparser
from src.tz import UTC
...
DATETIMES = [datetime(2003, 9, 2, 22, 14, 2), datetime(2003, 8, 8, 14, 9, 14), datetime(2003, 4, 7, 6, 14, 59)]
...
def __make_date_examples():
    ...
    dates_w_day = [date(1969, 12, 31), date(1900, 1, 1), date(2016, 2, 29), date(2017, 11, 14)]
...
def __make_time_examples():
    ...
    # HHMMSS / HH:MM:SS
    time_hms = [time(0, 0, 0), time(0, 15, 30), time(8, 2, 16), time(12, 0), time(16, 2), time(20, 45)]
    ...
    time_hmsu = [time(0, 0, 0, 0), time(4, 15, 3, 247993), time(14, 21, 59, 948730), time(23, 59, 59, 999999)]
...
@pytest.mark.parametrize(
    "isostr",
    ["24:00", "2400", "24:00:00", "240000", "24:00:00.000", "24:00:00,000", "24:00:00.000000", "24:00:00,000000"],
)
