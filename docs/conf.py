#!/usr/bin/env python3
#
# dateutilx documentation build configuration file, created by
...
latex_documents = [("index", "dateutilx.tex", "dateutilx Documentation", "dateutilx", "manual")]
...
man_pages = [("index", "dateutilx", "dateutilx Documentation", ["dateutilx"], 1)]
