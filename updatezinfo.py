...
def main(metadata_file):
    ...
    rebuild.rebuild(metadata["tzdata_file"], zonegroups=metadata["zonegroups"], metadata=metadata)
    print("Done.")
...
if __name__ == "__main__":
    ...
    parser.add_argument("metadata", metavar="METADATA_FILE", default=METADATA_FILE, nargs="?")
